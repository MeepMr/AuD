...
// Methoden zum Traversieren
	...
	private String traversierePreOrder(final Knoten<T> einKnoten)
	{
		...
		sAusgabe = einKnoten.toString();

		if(einKnoten.getKnotenLinks() != null) {

			sAusgabe += ", " + traversierePreOrder(einKnoten.getKnotenLinks());
		}

		if(einKnoten.getKnotenRechts() != null) {

			sAusgabe += ", " + traversierePreOrder(einKnoten.getKnotenRechts());
		}
	...
	private String traversiereInOrder(final Knoten<T> einKnoten)
	{
		...
		if(einKnoten.getKnotenLinks() != null) {
			...
			if(sAusgabe != "") {
				...
				sAusgabe += ", " + traversiereInOrder(einKnoten.getKnotenLinks());
			} else {
		...
		if(einKnoten.getKnotenRechts() != null) {
			...
			sAusgabe += ", " + traversiereInOrder(einKnoten.getKnotenRechts());
		}
	...
	private String traversierePostOrder(final Knoten<T> einKnoten)
	{
		...
		if(einKnoten.getKnotenLinks() != null) {
			...
			if(sAusgabe != "") {
				...
				sAusgabe += ", " + traversierePostOrder(einKnoten.getKnotenLinks());
			} else {
		...
		if(einKnoten.getKnotenRechts() != null) {
			...
			if(sAusgabe != "") {
				...
				sAusgabe += ", " + traversierePostOrder(einKnoten.getKnotenRechts());
			} else {
