...
// Methoden zum Suchen
	...
	{
		int iCheck = 0;
		AVLKnoten<T> knoten = this.getWurzel();
...
// Methode zum Traversieren
	...
	{
		String sAusgabe = "";
		Stack<AVLKnoten> stack = new Stack();
		stack.push(this.getWurzel());

		do{

			System.out.println(sAusgabe);
			AVLKnoten x = stack.pop();
			sAusgabe += x.getDaten().toString();
			if(x.getKnotenRechts() != null) stack.push(x.getKnotenRechts());
			if(x.getKnotenLinks() != null) stack.push(x.getKnotenLinks());
